...
os.remove("/Users/kellyquinn/Desktop/ORISE/HSSP_Code/Project_01/Homicide_Data/Data_Sets/2021/RMS_Crime_Incidents.csv")
...
df = pd.read_csv("/Users/kellyquinn/Desktop/ORISE/HSSP_Code/Project_01/Homicide_Data/Data_Sets/2021/RMS_Crime_Incidents.csv")
# print(df)
...
sorted_df.to_csv('/Users/kellyquinn/Desktop/ORISE/HSSP_Code/Project_01/Homicide_Data/Data_Sets/2021/detroit_homicide_sorted.csv', index=False)

df = pd.read_csv("/Users/kellyquinn/Desktop/ORISE/HSSP_Code/Project_01/Homicide_Data/Data_Sets/2021/detroit_homicide_sorted.csv")
# print(df)

# 2022 
# Data not published yet as of 01/25/2022
contains_values = df[df['incident_timestamp'].str.contains('2021', na=False)]
# print(contains_values)

#Create new dataframe
contains_values.to_csv('/Users/kellyquinn/Desktop/ORISE/HSSP_Code/Project_01/Homicide_Data/Data_Sets/2021/detroit_homicide_2021.csv', index=False)

df = pd.read_csv("/Users/kellyquinn/Desktop/ORISE/HSSP_Code/Project_01/Homicide_Data/Data_Sets/2021/detroit_homicide_2021.csv")
print(df)

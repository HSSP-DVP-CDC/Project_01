...
os.remove("/Users/kellyquinn/Desktop/ORISE/HSSP_Code/Project_01/Homicide_Data/Data_Sets/2021/Exported Data.csv")
...
# Print the data fram
df = pd.read_csv("/Users/kellyquinn/Desktop/ORISE/HSSP_Code/Project_01/Homicide_Data/Data_Sets/2021/Exported Data.csv")
# print(df)

# 2021
#Grab only values that are '09A' or 'Murder' for 2021
contains_values = df[df['IncidentDate'].str.contains('2021')]

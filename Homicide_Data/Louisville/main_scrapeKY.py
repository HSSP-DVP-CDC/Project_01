...
os.remove("/Users/kellyquinn/Desktop/ORISE/HSSP_Code/Project_01/Homicide_Data/Data_Sets/CRIME_DATA_2021.csv")
...
#Read .csv file
df = pd.read_csv('Data_Sets/CRIME_DATA_2021.csv')
# print(df)
...
sorted_df.to_csv('Data_Sets/kentucky_homicide_sorted.csv', index=False)

df = pd.read_csv("Data_Sets/kentucky_homicide_sorted.csv")
# print(df)
...
#Create new dataframe
contain_values.to_csv('Data_Sets/kentucky_homicide_09A.csv', index=False)

df = pd.read_csv("Data_Sets/kentucky_homicide_09A.csv")
print(df)

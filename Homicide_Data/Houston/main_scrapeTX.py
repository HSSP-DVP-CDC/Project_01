...
os.remove("/Users/kellyquinn/Desktop/ORISE/HSSP_Code/Project_01/Homicide_Data/Data_Sets/NIBRSPublicViewDec21.xlsx")
os.remove("/Users/kellyquinn/Desktop/ORISE/HSSP_Code/Project_01/Homicide_Data/Data_Sets/NIBRSPublicViewDec21.csv")
...
read_file = pd.read_excel('Data_Sets/NIBRSPublicViewDec21.xlsx')
read_file.to_csv("Data_Sets/NIBRSPublicViewDec21.csv")

df = pd.read_csv("Data_Sets/NIBRSPublicViewDec21.csv")
# print(df)
...
sorted_df.to_csv('Data_Sets/texas_homicide_sorted.csv', index=False)

sorted_df = pd.read_csv("Data_Sets/texas_homicide_sorted.csv")
# print(df)
...
#Create new dataframe
contain_values.to_csv('Data_Sets/texas_homicide_09A.csv', index=False)

df = pd.read_csv("Data_Sets/texas_homicide_09A.csv")
print(df)

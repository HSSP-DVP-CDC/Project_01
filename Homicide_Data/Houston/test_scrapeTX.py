...
read_file.to_csv("Homicide_Data/Houston/NIBRSPublicViewNov21.csv")

df = pd.read_csv("Homicide_Data/Houston/NIBRSPublicViewNov21.csv")
print(df)
...
sorted_df = pd.read_csv("Homicide_Data/Houston/texas_homicide_sorted.csv")
print(df)
